...
const pagination = document.querySelector(".main__slider-pagination");
const buttonBack = document.querySelector(".main__slider-button-back");
const buttonNext = document.querySelector(".main__slider-button-next");
